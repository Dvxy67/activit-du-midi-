                ...
                <form method="POST" action="{{ route('admin.activities.store') }}">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <input type="time" name="activity_time" value="{{ old('activity_time') }}"
                                   class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent">
                            @error('activity_time')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        <div>
                            ...
                            <input type="number" name="max_participants" value="{{ old('max_participants', 20) }}" min="1"
                                   class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="number" name="points_cost" value="{{ old('points_cost', 0) }}" min="0"
                                   class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent">
                            @error('points_cost')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
